...
Source0  : https://files.pythonhosted.org/packages/32/6c/57df6196ce52c464cf8556e8f697fec5d3469bb8cd319c1685c0a090e0b4/tenacity-8.3.0.tar.gz
...
%prep
%setup -q -n tenacity-8.3.0
cd %{_builddir}/tenacity-8.3.0
pushd ..
cp -a tenacity-8.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715096345
