...
Source0  : https://files.pythonhosted.org/packages/9a/dc/7b9818743ab08d53245b777639b6c2d274be8e7eb09b1131885958a3f517/tenacity-8.4.2.tar.gz
...
%prep
%setup -q -n tenacity-8.4.2
cd %{_builddir}/tenacity-8.4.2
pushd ..
cp -a tenacity-8.4.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719250497
