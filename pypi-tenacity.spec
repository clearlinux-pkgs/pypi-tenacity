...
Source0  : https://files.pythonhosted.org/packages/a3/4d/6a19536c50b849338fcbe9290d562b52cbdcf30d8963d3588a68a4107df1/tenacity-8.5.0.tar.gz
...
%prep
%setup -q -n tenacity-8.5.0
cd %{_builddir}/tenacity-8.5.0
pushd ..
cp -a tenacity-8.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720197225
