...
Source0  : https://files.pythonhosted.org/packages/0a/d4/2b0cd0fe285e14b36db076e78c93766ff1d529d70408bd1d2a5a84f1d929/tenacity-9.1.2.tar.gz
...
%prep
%setup -q -n tenacity-9.1.2
cd %{_builddir}/tenacity-9.1.2
pushd ..
cp -a tenacity-9.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743603016
