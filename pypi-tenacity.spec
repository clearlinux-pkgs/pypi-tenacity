...
Source0  : https://files.pythonhosted.org/packages/d3/f0/6ccd8854f4421ce1f227caf3421d9be2979aa046939268c9300030c0d250/tenacity-8.2.2.tar.gz
...
%prep
%setup -q -n tenacity-8.2.2
cd %{_builddir}/tenacity-8.2.2
pushd ..
cp -a tenacity-8.2.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677601674
